...
/**
 * This class is just a wrapper to hold the initialization of Nuxeo Cmis
 * until we have received the "go ahead"
 * from the Runtime and that everything is fully initialized.
 *
 */
