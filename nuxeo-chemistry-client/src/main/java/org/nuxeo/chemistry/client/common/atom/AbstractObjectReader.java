...
public abstract class AbstractObjectReader<T> extends AbstractEntryReader<T> {
    ...
    protected abstract void readProperty(ReadContext ctx, StaxReader reader, T object, XmlProperty p);
    ...
    protected void readCmisObject(ReadContext ctx, StaxReader reader, T object) throws XMLStreamException {
    ...
    protected void readObjectChildElement(ReadContext ctx, StaxReader reader, T object) throws XMLStreamException {
    ...
    protected void readProperties(ReadContext ctx, StaxReader reader, T object) throws XMLStreamException {
    ...
    protected void readAllowableActions(ReadContext ctx, StaxReader reader, T object) throws XMLStreamException {
        // TODO not yet implemented
    }

    protected void readOtherCmisElement(ReadContext ctx, StaxReader reader, T object) throws XMLStreamException {
        // do nothing
    }
