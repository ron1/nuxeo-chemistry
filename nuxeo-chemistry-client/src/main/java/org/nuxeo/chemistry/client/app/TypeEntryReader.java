 ...
 *
 */
public class TypeEntryReader extends AbstractEntryBuilder<APPType> {

    public final static TypeEntryReader INSTANCE = new TypeEntryReader();
    
    @Override
    protected APPType createObject(BuildContext ctx) {
    ...
    @Override
    protected void readCmisElement(BuildContext context, StaxReader reader, APPType entry)
