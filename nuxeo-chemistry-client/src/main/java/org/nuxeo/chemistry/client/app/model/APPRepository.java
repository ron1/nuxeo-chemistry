...
import org.nuxeo.chemistry.client.app.service.ServiceFeedReader;
    ...
    protected void loadTypes() {
        if (typeRegistry == null) {
            try {
                ...
                try {
                    typeRegistry = TypeFeedReader.INSTANCE.read(new ReadContext(this), in);
                } finally {
                    in.close();
                }
    ...
    protected void loadServices() {
        if (services == null) {
            ...
            if (href != null) {
                ...
                try {
                    try {
                        services = ServiceFeedReader.getBuilder().read(new ReadContext(this), in);            
                    } finally {
                        in.close();
                    }
                } catch (Exception e) {
